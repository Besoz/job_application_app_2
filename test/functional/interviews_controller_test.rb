...
class InterviewsControllerTest < ActionController::TestCase
  ...
  test "should create interview" do
    assert_difference('Interview.count') do
      post :create, interview: { application_id: @interview.application_id, score: @interview.score, type_id: @interview.type_id }
    end
  ...
  test "should update interview" do
    put :update, id: @interview, interview: { application_id: @interview.application_id, score: @interview.score, type_id: @interview.type_id }
    assert_redirected_to interview_path(assigns(:interview))
  end
